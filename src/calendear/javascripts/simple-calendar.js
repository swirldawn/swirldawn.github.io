    ...
    _createClass(SimpleCalendar, [{
        ...
        value: function create() {
            ...
            if (this._options.showDate == "") {
                ...
                this.tmonth = new Date().getMonth() + 1;
                this.tday = new Date().getDate();
            } else {
                var show_date = this._options.showDate.split("-");
                this.tyear = show_date[0];
                this.tmonth = show_date[1];
                this.tday = show_date[2];
            }
        ...
        value: function addData(year, month) {
            ...
            for (var i = 0; i < 42; i++) {
                ...
                if (this._options.showLunarCalendar) {
                    //卅
                    var showNongLi = new LunarHelp(writeyear, writemonth, writeday).getLunarDayName();
                    if (showNongLi == "三日") {
                        daysElement[i].querySelector('.lunar-day').innerHTML = "卅日";

                    } else {
                        daysElement[i].querySelector('.lunar-day').innerHTML = showNongLi;
                    }
            ...
            if (options.showMark) {
                ...
                if (data1) {
                    daysElement.forEach(function(v, i) {
                        ...
                        if (data1[year + '-' + currentmonth + '-' + day]) {
                            v.classList.add('sc-othermenth');
                            v.title = data1[year + '-' + currentmonth + '-' + day];
                        } else {
                            v.classList.remove('sc-othermenth');
                            v.title = '';
                        }
                    });
                }
